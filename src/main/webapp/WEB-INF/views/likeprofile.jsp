...
<body>
		...
		<section class="content">
			...
			<article>
				<div class="profile_wrap">
					<div class="left_side">
						<img src="img/${profile.imgname1}" alt="대표 이미지">
					</div>
					<div class="right_side">
						<ul>
							<h2><li>${profile.custname}, ${profile.custage}</li></h2><br/>
							<li>${profile.custbirth}</li>
	...
	<aside>
		<div class="user_profile">
			<!--  <h3>나의 프로필</h3> -->
			<a href="/profile?custno=${custno}"> <i class="fas fa-user-circle fa-3x"></i>
			<h4>${custname}</h4>
            <span>${custrank}</span>
			</a>
